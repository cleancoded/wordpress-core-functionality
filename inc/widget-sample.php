 ...
 * @since 1.0.0
 */
class CC_Sample_Widget extends WP_Widget {
	...
	function __construct() {
		...
		// load widget
		parent::__construct( $widget_slug, 'CC_Sample_Widget', $widget_ops, $control_ops );		
...
add_action( 'widgets_init', create_function( '', "register_widget('CC_Sample_Widget');" ) );
